...
import RcTooltip from './ant/rc-tooltip/Tooltip';
import { AdjustOverflow, getPlacements } from './Placements';
...
function getDisabledCompatibleChildren(element: React.ReactElement) {
...
export class Tooltip extends React.Component<TooltipProps, any> {
  ...
  render() {
    ...
    const { openClassName, getPopupContainer, getTooltipContainer } = props;
    const children = props.children as React.ReactElement;
    const prefixCls = 'axiom-tooltip';
    let { visible } = state;
    ...
    return (
      <RcTooltip
        {...(this.props as any)} // 🐉🐉🐉 Ant is fucking terrible with their typing. This is risky but works right now.
        prefixCls={prefixCls}
